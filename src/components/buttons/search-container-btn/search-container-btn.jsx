          ...
          results.map((result, index) => {
            return (
              <SearchElementBtn
                ...
                description={formatEventDate(result.event.date)}
                onClick={closeSearchModal}
                type={result.type}
                elementId={result.event.id}
              />
            );
          })}
        {type === "city" &&
          ...
          results.map((result, index) => {
            return (
              <SearchElementBtn
                ...
                description={`${result.city.eventsCount} événement${
                  result.city.eventsCount > 1 ? "s" : ""
                }`}
                onClick={closeSearchModal}
                type={result.type}
                elementId={result.city.id}
              />
            );
          })}
        {type === "place" &&
          ...
          results.map((result, index) => {
            return (
              <SearchElementBtn
                ...
                description={`${result.place.eventsCount} événement${
                  result.place.eventsCount > 1 ? "s" : ""
                }`}
                onClick={closeSearchModal}
                type={result.type}
                elementId={result.place.id}
              />
            );
          })}
        {type === "organizer" &&
          ...
          results.map((result, index) => {
            return (
              <SearchElementBtn
                ...
                description={`${result.user.eventsCount} événement${
                  result.user.eventsCount > 1 ? "s" : ""
                }`}
                onClick={closeSearchModal}
                type={result.type}
                elementId={result.user.id}
              />
            );
          })}
      </motion.div>
